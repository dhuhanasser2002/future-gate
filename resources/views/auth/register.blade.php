        ...
        <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
            ...
            <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
                <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
                    <h1><a href="http://blog.stackfindover.com/" rel="dofollow">Future Gate</a></h1>
                </div>
...
@endforeach
                            ...
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="name" value="{{ old('username') }}" class="form-control" id="floatingName"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="password" name="password_confirmation" class="form-control"
                                        id="floatingPasswordCon" placeholder="Confirm Password">
                                    <label for="floatingPasswordCon">Confirm Password</label>
                                </div>
